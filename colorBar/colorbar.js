// from https://github.com/bmschmidt/colorbar
function Colorbar() {
    var scale, // the input scale this represents;
        margin = { top: 20, right: 70, bottom: 10, left: 10 },
        orient = "vertical",
        origin = {
            x: 0,
            y: 0
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            if (scale.type == "QUANTILE") {
                ...
                colorAxisFunction.tickFormat(function(d) {
                    return scale.ticks[d];
                })
            }
            ...
            //this rotates the tick labels.... but problems with pieces of labels hidden
            //.selectAll("text")  
